---
title: "Examination of Trends in MIMIC Invasive Species Data"
...
We are aware that the *Palaemon* was not searched for in the first few years of
the program, but it was not found anywhere in New England until a few years ago,
so that is unlikely to be a problem. A  few other species were also added to the
program over the period of record, as they became more abundant in New England.
