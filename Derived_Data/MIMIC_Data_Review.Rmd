...
One observer (?) noted Green Crab, the other did not. Perhaps one was a a
trainer and the other was a trainee.  The abundance data differs in several
places by one abundance class.
...
do not count data where species were recorded as "present", which is
problematic. A decision needs t be made on each specific analysis of the
relative abundance data whether to replace those NAs with "Absent" or not.
